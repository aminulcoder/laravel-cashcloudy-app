...
const Review = () => {
  return (
    <div className='font-Inter '>
      <h2 className='text-center text-gray-950 font-semibold text-xl sm:text-2xl font-Inter pb-3'>Confirm and send</h2>

      <div className=" space-y-3 pb-6 ">
        <div className="flex justify-between">
          <p className='text-base font-Inter font-semibold'>Transfer details</p>
      ...
      <div className=" space-y-3  border-t py-6 ">
          ...
          <div>
            ...
            <div class="mt-2">
              <div class="flex items-center rounded-md bg-white pl-3 outline outline-1 -outline-offset-1 outline-gray-300 has-[input:focus-within]:outline has-[input:focus-within]:outline-2 has-[input:focus-within]:-outline-offset-2 has-[input:focus-within]:outline-indigo-600 sm:py-2">
                ...
                <input type="text" name="price" id="price" class="block min-w-0 grow py-1 sm:py-1.5 pl-1 pr-3 text-base text-gray-900 placeholder:text-gray-400 focus:outline focus:outline-0 sm:text-sm/6" placeholder="Enter Reference" />
        ...
        className=' bg-violet-600 text-white font-semibold py-2'>Confirm and send</button>
      </div>
